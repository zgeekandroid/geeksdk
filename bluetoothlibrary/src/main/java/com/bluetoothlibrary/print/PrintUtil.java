...
public class PrintUtil {
    ...
    private static final String DEFAULT_BLUETOOTH_INFO = "default_bluetooth_info";

    public static final String ACTION_PRINT_TEST = "action_print_test";
    public static final String ACTION_PRINT = "action_print";
    public static final String ACTION_PRINT_CONN = "action_print_conn";
    ...
    public static void setDefaultBluetoothInfo(Context mContext, String value) {
        SharedPreferences sharedPreferences = mContext.getSharedPreferences(FILENAME, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putString(DEFAULT_BLUETOOTH_INFO, value);
        editor.apply();
    }
    ...
    public static String getDefaultBluetoothInfo(Context mContext) {
        SharedPreferences sharedPreferences = mContext.getSharedPreferences(FILENAME, Context.MODE_PRIVATE);
        return sharedPreferences.getString(DEFAULT_BLUETOOTH_INFO, "");
    }
