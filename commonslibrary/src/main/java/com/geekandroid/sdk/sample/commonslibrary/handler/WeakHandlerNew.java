package com.geekandroid.sdk.sample.commonslibrary.handler;
...
/**
 * date        :  2016-04-09  14:25
 * author      :  Mickaecle gizthon
 * description :
 */
public class WeakHandlerNew {
         ...
         */
        public WeakHandlerNew(@Nullable Handler.Callback callback) {
         ...
         */
        public WeakHandlerNew(@NonNull Looper looper) {
            mCallback = null;
         ...
         * @param callback The callback interface in which to handle messages, or null.
         */
        public WeakHandlerNew(@NonNull Looper looper, @NonNull Handler.Callback callback) {
            mCallback = callback;
