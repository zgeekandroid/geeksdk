package com.geekandroid.sdk.qrcode.camera;/*
...
import com.geekandroid.sdk.qrcode.camera.open.OpenCameraInterface;
...
public final class CameraManager {
	...
	public synchronized Rect getFramingRect() {
		if (framingRect == null) {
			...
			Log.d(TAG, "Calculated framing screenResolution.x : " + screenResolution.x + "  screenResolution.y : " + screenResolution.y);
			Log.d(TAG, "Calculated framing width : " + width + "  height : " + height);
			if (screenResolution.x < 500) {
				height = width;
			}

			int leftOffset = (screenResolution.x - width) / 2;
			int topOffset = 2 * (screenResolution.y - height) / 5;
