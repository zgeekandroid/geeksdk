...
public final class PreferencesFragment extends PreferenceFragment implements SharedPreferences.OnSharedPreferenceChangeListener {
	...
	public void onCreate(Bundle icicle) {
		...
		checkBoxPrefs = findDecodePrefs(preferences, com.geekandroid.sdk.qrcode.camera.decoding.PreferencesActivity.KEY_DECODE_1D_PRODUCT, com.geekandroid.sdk.qrcode.camera.decoding.PreferencesActivity.KEY_DECODE_1D_INDUSTRIAL, com.geekandroid.sdk.qrcode.camera.decoding.PreferencesActivity.KEY_DECODE_QR, PreferencesActivity.KEY_DECODE_DATA_MATRIX, com.geekandroid.sdk.qrcode.camera.decoding.PreferencesActivity.KEY_DECODE_AZTEC, PreferencesActivity.KEY_DECODE_PDF417);
		disableLastCheckedPref();

		EditTextPreference customProductSearch = (EditTextPreference) preferences.findPreference(com.geekandroid.sdk.qrcode.camera.decoding.PreferencesActivity.KEY_CUSTOM_PRODUCT_SEARCH);
